...
Description: This script performs a test/train split using a simple neural network over
             the colours data reporting either the mean squared error or r squared loss.

Usage: python nn.py <colours csv file> <loss function>

Options for loss function:
  1. mean_squared_error
  2. negative_r_squared (deafult)

Example:
  python3 nn.py colours_mlr_expanded.csv mean_squared_error
"""
import numpy as np
...
# Compile the model
lloss = "negative_r_squared"
if len(argv) < 2:
    lloss = argv[2]
if(lloss == "mean_squared_error"):
