# -*- coding: utf-8 -*-
"""
Created on Thu Oct 26 11:13:25 2023
...
def negative_r_squared(y_true, y_pred):
    ...
    return -r_squared
# load dataset
# dataset = np.loadtxt('C:\\Users\\salterm\\Desktop\\School\\Research\\Color\\Data\\colours_mlr_expanded.csv', delimiter=',')
dataset = np.loadtxt('wavelength_rgb_data.txt', delimiter=',')
...
model.fit(X_train, y_train, epochs=100, batch_size=3200, verbose=2)
